...
This document describes MCE version 1.699_013
...
Provides threads-like behavior for executing code asynchronously via child
processes.
...
Nine classes are included for use with MCE::Shared.

=over 3

=item * L<MCE::Shared::Array>

=item * L<MCE::Shared::Condvar>

=item * L<MCE::Shared::Handle>
...
=item * L<MCE::Shared::Queue>

=item * L<MCE::Shared::Scalar>
...
Perl 5.10.1 or later. PDL::IO::Storable is required in scripts running PDL.
