...
This document describes MCE::Core version 1.811
...
Below, a new instance is configured with all available options.
   ...
   my $mce = MCE->new(
      ...
      use_slurpio => 1,                   ## Default 0
         ...
         # non-threads spawned via fork. This is set automatically to 1
         # if (F)CGI.pm, Gearman::XS, Mojo::IOLoop, or Tk is present.
