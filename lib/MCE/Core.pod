...
This document describes MCE::Core version 1.829
...
Below, a new instance is configured with all available options.
   ...
   my $mce = MCE->new(
      ...
      use_slurpio => 1,                   ## Default 0
         ...
         # or running inside an eval block implies posix_exit => 1 or if
         # present Curses, CGI, FCGI, Prima, Gearman::Util, Gearman::XS,
         # Coro, Mojo::IOLoop, Tk, Wx, or Win32::GUI.

         # Not all modules on CPAN are thread-safe nor safe to use running
         ...
         # under: e.g. Cache::BDB, IO::Socket::INET::Daemon.
