...
This document describes MCE::Examples version 1.804
...
=head1 FCGI::PROCMANAGER and MCE DEMONSTRATIONS

The demonstrations requires MCE 1.804 to run. Otherwise, the MCE C<posix_exit>
option must be specified and set to 1. This is done automatically in 1.804
whenever C<(F)CGI.pm> is present.
