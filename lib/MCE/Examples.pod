...
MCE::Examples - Various examples demonstrating Many-Core Engine

=head1 VERSION

This document describes MCE::Examples version 1.699_001
...
Github repository L<https://github.com/marioroy/mce-examples|MCE Examples>
and no longer included with the Perl MCE distribution.
